                                ...
                                <div class="">
                                    <table class="table zero-configuration">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td style="min-width: 30rem; text-align: left;">
                                                <a href="<?= route('admin.post.edit', [$post->id]) ?>" class="btn btn-info waves-effect waves-light">ویرایش</a>

                                                <form class="d-inline" action="<?= route('admin.post.status', [$post->id]) ?>" method="post">
                                                    <input type="hidden" name="_method" value="put">
                                                    <button type="submit"
                                                            class="btn <?= $post->status == 1 ? 'btn-success' : 'btn-warning' ?> waves-effect waves-light">
